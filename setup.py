...
if __name__ == '__main__':
    setup(
        ...
        version=polib2.__version__,
        author=maintainer,
        author_email=maintainer_email,
        maintainer=maintainer,
        maintainer_email=maintainer_email,
        url='https://github.com/gislite/polib2.git',
        # download_url='https://pypi.python.org/packages/source/p/polib/polib-%s.tar.gz' % polib2.__version__,
        license='MIT',
        platforms=['posix'],
        classifiers = [
